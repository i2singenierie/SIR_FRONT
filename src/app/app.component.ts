...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // la logic de zoom vers les changements des features
    ...
    // ajout des control vres la carte 
    ...
    map.on("click", (event: any) => {
      ...
      //pour récuper les coordonnées des deux points control 3
      ...
      //pour récuper les coordonnées des deux points control 1
    ...
    await fetch('http://www.cner.ma:9763/oauth2/token', {
      ...
      async (response2) => {
        ...
        if (response2.ok) {
          ...
          response2.json().then(async body => {
